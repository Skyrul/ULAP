...
class ImportCustomerLeadCompletedController extends Controller
{
	...
	public function actionIndex($page)
	{
		...
		echo $inputFileName = 'csv/ImportCustomerLead/SecondLead/SecondLeads-'.$page.'.csv';
		...
		try
		{
			...
			foreach($customerKeyHolder as $customerPk => $customerLeadData)
			{
				...
				if($customer !== null)
				{
					...
					{
						$criteria = new CDbCriteria;
						$criteria->compare('name', 'System Imported Completed List');
						...
						{
							$model = new Lists;
							$model->name = 'System Imported Completed List';
