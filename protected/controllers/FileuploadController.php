...
class FileuploadController extends Controller
{
	...
	public function actionUpdate($id)
    {
        ...
        if(isset($_POST['Fileupload']))
        {
            $_POST['Fileupload']['original_filename'] = $model->original_filename;
            $model->attributes=$_POST['Fileupload'];
            ...
            if($model->save())
            {
                ...
                {
                    $uploadedFile->saveAs(Yii::app()->basePath.'/../fileupload/'.$model->image);
                }
                $this->redirect(array('admin'));
            }
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='fileupload-form')
		{
