...
class CronAgentPerformanceController extends Controller
{
	...
	public function actionIndex($forceReprocess = false)
	{
		...
		if($forceReprocess == 1)
		{
			$agentPerformanceReportNotDone = $agentPerformanceReportOngoing;
			$agentPerformanceReportOngoing = null;
		}
			...
			if( $dateFilterStart != '' && $dateFilterEnd != '' )
			{
				...
				{	
					foreach($models as $model)
					{
						...
						echo '<br><br> Account Loop: '.date('H:i:s');
