...
class EmailTemplateController extends Controller
{
	...
	public function actionSend($id)
	{
		...
		$emailList = explode(',', $model->email_to);
		...
		try
		{
			foreach($emailList as $email)
			{
				...
				$emailLog->email_template_id = $model->id;
				$emailLog->sender_id = $model->creator_id;
				$emailLog->receiver_email_address = $email;
				$emailLog->type = EmailLog::TYPE_EMAIL_TO;
				if(!$emailLog->save())
				{
			...
			$emailList = explode(',', $model->email_cc);
			...
			foreach($emailList as $email)
			{
				...
				$emailLog->sender_id = $model->creator_id;
				$emailLog->receiver_email_address = $email;
				$emailLog->type = EmailLog::TYPE_EMAIL_CC;
				if(!$emailLog->save())
				{
					print_r($emailLog->getErrors());
				}
			...
			$emailList = explode(',', $model->email_bcc);
			...
			foreach($emailList as $email)
			{
				...
				$emailLog->sender_id = $model->creator_id;
				$emailLog->receiver_email_address = $email;
				$emailLog->type = EmailLog::TYPE_EMAIL_BCC;
				if(!$emailLog->save())
				{
					print_r($emailLog->getErrors());
				}
