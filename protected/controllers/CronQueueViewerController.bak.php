...
class CronQueueViewerController extends Controller
{
	...
	public function actionIndex()
	{
		...
		// if( time() < strtotime('today 4:00 am') && $customerPriorityCurrentOffset->value == 0 && $customerPriorityQueryOngoing->value == 0 && $leadHopperReordering->value == 0 )
		// {
			// exit;
		// }
		...
		if( $currentRecordInQueueChecker->value >= 10 )
		{
