...
class CronQueueEvaluationController extends Controller
{
	...
	public function actionIndex()
	{
		...
		if( $evaluationFlag->value == 0 && $evaluationOffset->value <= $customerQueuesCount)
		{
			...
			// {
				...
				// $existingQueueViewers2 = CustomerQueueViewer::model()->findAll(array(
					// 'condition' => 'skill_id IN (38, 43, 45, 46, 47, 48, 49)',
					// 'order' => 'priority DESC',
				// )); 
				
				// $existingQueueViewers = array_merge($existingQueueViewers, $existingQueueViewers2);
		...
		if( $evaluationOffset->value > 0 && $evaluationOffset->value >= $customerQueuesCount )
		{
