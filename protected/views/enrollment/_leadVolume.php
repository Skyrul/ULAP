...
<table class="lead-volume-entries table">
	...
	<tr>		
		...
		<td>
			...
			<?php }else{?>
				<?php echo CHtml::textField('CustomerEnrollmentLevel['.$subsidyLevel['group_id'].'][qty]', 1, array('style'=>'width:60%;','class'=>'number-field skill-level-contract-level-quantity', 'readOnly'=>true)); ?>
			<?php } ?>
		</td>	
