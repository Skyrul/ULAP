		...
		delay(function(){
			$.ajax({
				...
				if(response.status == true)
				{
					...
					$("#agent-id-search-container").html("Agent ID not matching from \"'.$contract->company->company_name.'\" Database");
			});
...
<div class="page-content">
	<div class="page-content-area">
		...
		<div class="login-container  <?php echo ($this->pdfView === true) ? 'hidden' : ''; ?>" id="login-container">
		...
		<div id="contract-form-container" class="row <?php echo ($this->pdfView === true) ? '' : 'hidden'; ?>">
									...
									'clientOptions'=>array(
										...
										'afterValidate'=>'js:function(form, data, hasError){
											if(!hasError)
											{
												...
												$.ajax({
													url: yii.urls.absoluteUrl + "/site/checkEmailAddressIfAlreadyHaveAccount?contract=",
													type: "GET",	
													data: formData,
													dataType: "json",
