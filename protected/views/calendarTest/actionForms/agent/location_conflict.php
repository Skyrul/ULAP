...
<div class="profile-user-info profile-user-info-striped">
	...
	<div class="profile-info-row details-field-container">
		...
		<div class="profile-info-value">
			<?php 
				echo $form->textArea($model, 'customer_notes', array('class'=>'col-xs-12', 'disabled'=>true)); 
			?>
		</div>
	</div>
	...
	<div class="profile-info-row location-field-container">
		...
		<div class="profile-info-value">								
			...
			<?php 
				echo CHtml::dropDownList('', $model->location, $calendar->locationOptions('all'), array('id'=>'customerApprovedLocations', 'style'=>'display:none;'));
				echo CHtml::dropDownList('', $model->location, $calendar->locationOptions('all'), array('id'=>'allLocations', 'style'=>'display:none;'));
