					...
					<div class="profile-user-info profile-user-info-striped">
						...
						<div class="profile-info-row lead-field-container" style="display:none;">
							...
							<div class="profile-info-value">
								...
								<div class="col-sm-6">
									<?php echo CHtml::link('Add New Lead', array('/customer/leads', 'customer_id'=>$model->calendar->customer_id), array('class'=>'add-new-lead-link', 'target'=>'_blank', 'style'=>'line-height:30px; margin-left:-25px; display:none;')); ?>
								</div>
							</div>
						</div>
