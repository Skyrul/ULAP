...
$cs->registerScriptFile($baseUrl.'/js/calendar/calendar.js?'.time(),  CClientScript::POS_END);
...
$cs->registerCss(uniqid(), '
	...
	.color-key-btn li a:hover{ color:#333 !important; background:none !important; }
');
...
$cs->registerScript(uniqid(), '
	...
	$(".color-key-btn").mouseenter(function() {

		$(".color-key-btn").addClass("open");
		
	}).mouseleave(function() {
		
		$(".color-key-btn").removeClass("open");
...
<div class="page-header">
	<h1>
		...
		<?php if( Yii::app()->user->account->checkPermission('customer_calendar_settings_button','visible') ){ ?>
		...
		<?php if( Yii::app()->user->account->checkPermission('customer_calendar_manage_schedule_button','visible') ){ ?>
		...
		<div class="btn-group pull-right color-key-btn" style="margin-right:8px;">
			<button data-toggle="dropdown" class="btn btn-xs btn-white btn-primary btn-round dropdown-toggle" aria-expanded="true">
				<div style="float:left; margin:4px 3px 0 0;">
					<div>
						<div style="background: #ffb752; height: 4px; width: 5px; margin-right:1px; float:left"></div> 
						<div style="background: #6fb3e0; height: 4px; width: 5px; float:left"></div>
					</div>

					<div style="clear:both;"></div>

					<div style="margin-top:1px;">
						<div style="background: #d15b47; height: 4px; width: 5px; margin-right:1px; float:left"></div> 
						<div style="background: #9585bf; height: 4px; width: 5px; float:left"></div>
					</div>
				</div>
			...
			<ul class="dropdown-menu">
				...
				<li>
					<a>
						<div class="pull-left">
							<div style="height:15px; width:15px; background:#ffb752; margin-right:5px;"></div> 
						</div>
				...
				<li>
					<a>
						<div class="pull-left">
							<div style="height:15px;width:15px;background:#6fb3e0; margin-right:5px;"></div> 
						</div>
				...
				<li>
					<a>
						<div class="pull-left">
							<div style="height:15px; width:15px; background:#d15b47; margin-right:5px;"></div> 
						</div>
				...
				<li>
					<a>
						<div class="pull-left">
							<div style="height:15px; width:15px; background:#a0a0a0; margin-right:5px;"></div> 
						</div>
				...
				<li>
					<a>
						<div class="pull-left">
							<div style="height:15px;width:15px;background:#d58cdf;margin-right:5px;"></div> 
						</div>
				...
				<li>
					<a>
						<div class="pull-left">
							<div style="height:15px;width:15px;background:#9585bf;margin-right:5px;"></div> 
						</div>
				...
				<li>
					<a>
						<div class="pull-left">
							<div style="height:15px;width:15px;background:#333333;margin-right:5px;"></div> 
						</div>
