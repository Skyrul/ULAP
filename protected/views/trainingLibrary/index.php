...
$this->pageTitle = 'Engagex - Training Library';
...
$cs->registerCss(uniqid(), '
	...
	.file-thumb-title { text-align:center; width: auto; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; }
	...
	<?php foreach($categories as $category): ?>
		...
		<div class="rows">
			<div class="col-sm-12">
				...
				<?php
					 $files = TrainingLibraryFile::model()->findAll(array(
					...
					if( $files )
					{
						...
						{			
							$extension = pathinfo('trainingLibraryFiles/' . $file->fileUpload->generated_filename, PATHINFO_EXTENSION);
							...
							if( isset($file->fileUpload) )
							{
								...
								{
									$viewLink = Yii::app()->createUrl('hr/trainingLibrary/download', array('id'=>$file->id));
									$viewClass = '';
								}
							}
						?>
								...
								<div class="file-thumb-wrapper">
									...
									<div class="file-thumb">
										...
										<?php
											...
											{
												echo '<img src="'.Yii::app()->request->baseUrl.'/trainingLibraryFiles/thumbnails/'.$file->thumbnailFileUpload->generated_filename.'">';
											}
											else
											{
