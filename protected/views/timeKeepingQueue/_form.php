			...
			<div class="widget-body">
				<div class="widget-main">
					...
					<div>
						...
						*/ ?>
						<?php echo $form->textField($model,'date_of_request',array('class'=>'date-picker','placeholder'=>'mm/dd/yyyy')); ?>
					...
					<div>
						...
						<div>
							...
							<?php echo $form->textField($model,'date_of_make_time_up',array('class'=>'date-picker','placeholder'=>'mm/dd/yyyy')); ?>
							<?php /*<div class="row">
								<div class="col-xs-12 col-sm-6">
									<div class="input-group">
										<input class="form-control date-picker" type="text" data-date-format="dd-mm-yyyy">
