...
<?php 
	...
	$cs->registerScript(uniqid(), '
		...
		setInterval(function() { 
			...
			$.ajax({
				url: yii.urls.absoluteUrl + "/reports/agentState",
				type: "post",
				dataType: "json",
				data: { "ajax":1 },
				success: function(response){
					
					$(".agent-state-tbl > tbody").html(response.html);
		...
		$(document).on("click", ".force-logout", function(){
			
			var id = $(this).prop("id");
			
			$.ajax({
				url: yii.urls.absoluteUrl + "/reports/forceLogout",
				type: "post",
				dataType: "json",
				data: { "ajax":1, "id":id },
				success: function(response){
...
<div class="widget-box widget-color-dark">
	...
	<div class="widget-body">
		<div class="widget-main no-padding">
			<table class="table table-condensed table-bordered table-hover agent-state-tbl">
				<thead>
					<tr>
						<th>Employee Name</th>
						<th>State</th>
