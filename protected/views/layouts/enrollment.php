...
<html lang="en">
	...
	<body class="skin-1">
		...
		<div id="navbar" class="navbar navbar-default navbar-collapse h-navbar">
			...
			<div class="navbar-container <?php echo (
					isset(Yii::app()->params['is_policy_review']) 
					|| isset(Yii::app()->params['is_win_back'])
					|| isset(Yii::app()->params['is_policy_review_per_name'])
					) ?  '' : 'hidden'; ?>" id="navbar-container">
				<div class="navbar-header pull-left">
					<!-- #section:basics/navbar.layout.brand -->
					<a href="#" class="navbar-brand" style="position: absolute;width: 97%;left: 0;top: 0;text-align: center;margin: auto;">
						<small>
							<?php echo CHtml::image(Yii::app()->request->baseUrl.'/images/ximbeo.png','Ximbeo',array('style'=>'position: relative; top: -3px;margin-right:-8px')); ?>
							<?php echo isset(Yii::app()->params['contract_name']) ? '&nbsp;' . Yii::app()->params['contract_name'] : 'imbeo'; ?>
