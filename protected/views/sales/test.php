...
<?php Yii::app()->clientScript->registerScript('backgroundJs','
	...
	function change() {
		...
		//console.log("x:"+x);
		// console.log("y:"+y);
		// console.log("carouselColors:"+carouselColors);
...
<?php 
	...
	var initialSalesCount = '.$salesData['currentEnrollCount'].';
	...
	function ajaxChecker(){
		$.ajax({
			...
			console.log(data.count > initialSalesCount);
...
$(function () {
    ...
    // $('#graph-container-807').highcharts({
        // title: {
            // text: '".date("F")."',
            // x: -20 //center
        // },
        ...
        // series: [
			// {
				// name: 'Actual',
				// data: ".json_encode(array_values($salesRepData[807]['dailySales']))."
			// },
			// {
				// name: 'Goal',
				// data: ".json_encode(array_values($salesRepData[807]['goalSales']))."
			// },
			// {
				// name: 'Stretch',
				// data: ".json_encode(array_values($salesRepData[807]['stretchSales']))."
			// }
		// ]
    // });
});
		...
		<div class="col-sm-4 left-container"><!-- LEFT COLUMN-->
			...
			<div class="row">
				...
				<div class="daily-pace-stats">
					...
					<div class="row">
						<div class="col-sm-12 text-center">
							<span class="number sred"><?php echo $salesData['dailyPaceVariance']; ?></span> 
