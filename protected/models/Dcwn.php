...
/**
 * This is the model class for table "{{dcwn}}".
 *
 * The followings are the available columns in table '{{dcwn}}':
 * @property integer $id
 ...
 */
class Dcwn extends CActiveRecord
{
	/**
	 ...
	 * @return Dcwn the static model class
	 */
