 ...
 */
class CalendarAppointment extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			// array('customer_notes', 'appointmentTitleIsConflict'),
	...
	public function appointmentTitleIsConflict($attribute, $params)
	{
		if(in_array($this->title, array("SCHEDULE CONFLICT", "LOCATION CONFLICT")))
			$this->addError('customer_notes', 'Kindly enter a note!');
	}
}
