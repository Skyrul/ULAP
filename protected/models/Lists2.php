 ...
 */
class Lists2 extends AuditCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('customer_id, skill_id, calendar_id, survey_id, fileupload_id, lead_ordering, manually_enter, allow_custom_fields, allow_area_code_assignment, duplicate_action, number_of_leads, type, status', 'numerical', 'integerOnly'=>true),
	...
	public function attributeLabels()
	{
		return array(
			...
			'skill_id' => 'Skill Assignment', // call_type
			...
			'is_default_call_schedule' => 'Customer Call Schedule',
