...
/**
 * This is the model class for table "{{calendar_holiday}}".
 *
 * The followings are the available columns in table '{{calendar_holiday}}':
 * @property integer $id
...
class CalendarHoliday extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, calendar_id, name, date', 'safe', 'on'=>'search'),
		);
	}
