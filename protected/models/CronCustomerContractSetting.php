...
/**
 * This is the model class for table "{{cron_customer_contract_setting}}".
 *
 * The followings are the available columns in table '{{cron_customer_contract_setting}}':
 * @property integer $id
 ...
 */
class CronCustomerContractSetting extends CActiveRecord
{
	/**
	...
	{
		return '{{cron_customer_contract_setting}}';
	}
