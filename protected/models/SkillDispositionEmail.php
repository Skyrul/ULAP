...
/**
 * This is the model class for table "{{skill_disposition_email}}".
 *
 * The followings are the available columns in table '{{skill_disposition_email}}':
 * @property integer $id
 ...
 */
class SkillDispositionEmail extends CActiveRecord
{
	/**
	...
	{
		return '{{skill_disposition_email}}';
	}
	...
	public function rules()
	{
		...
		return array(
			array('skill_disposition_id, email_address, email_subject, email_content, is_goal_disposition, is_details, is_callback_date, is_callback_time, is_note', 'required'),
			array('skill_disposition_id, is_goal_disposition, is_details, is_callback_date, is_callback_time, is_note', 'numerical', 'integerOnly'=>true),
			array('email_address', 'length', 'max'=>128),
			array('email_subject', 'length', 'max'=>250),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, skill_disposition_id, email_address, email_subject, email_content, is_goal_disposition, is_details, is_callback_date, is_callback_time, is_note', 'safe', 'on'=>'search'),
		);
	}
