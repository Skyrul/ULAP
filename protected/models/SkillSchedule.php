 ...
 */
class SkillSchedule extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('skill_id, schedule_start, schedule_end, schedule_day, status', 'required'),
			array('skill_id, schedule_start, schedule_end, schedule_day, status, is_deleted', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, skill_id, schedule_start, schedule_end, schedule_day, status, is_deleted, date_created, date_updated', 'safe', 'on'=>'search'),
		);
	}
