 ...
 */
class CustomerFile extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('customer_id, fileupload_id, user_account_id, type, status', 'numerical', 'integerOnly'=>true),
			array('date_created, date_updated', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, customer_id, fileupload_id, user_account_id, type, status, date_created, date_updated', 'safe', 'on'=>'search'),
		);
	}
