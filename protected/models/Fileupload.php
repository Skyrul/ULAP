...
class Fileupload extends CActiveRecord
{
	...
	public $imagePath;
	public $imagePathThumb;

	public function init()
	{
		$this->imagePath = Yii::app()->basePath.'/../fileupload/';
		$this->imagePathThumb = Yii::app()->basePath.'/../fileupload/thumb/';
	}
	...
	{
		return Yii::app()->request->baseUrl.'/fileupload/thumb/'.$this->generated_filename;
	}
	
	public function getOriginalImageFullPath()
	{
		return Yii::app()->request->baseUrl.'/fileupload/'.$this->generated_filename;
	}
	
	public function getFlyerImageFullPath()
	{
		return Yii::app()->request->baseUrl.'/fileupload/'.$this->generated_filename;
	}
