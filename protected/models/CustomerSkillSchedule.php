...
/**
 * This is the model class for table "{{skill_schedule}}".
 *
 * The followings are the available columns in table '{{skill_schedule}}':
 * @property integer $id
 ...
 */
class CustomerSkillSchedule extends CActiveRecord
{
	...
	{
		return '{{customer_skill_schedule}}';
	}
	...
	public function rules()
	{
		...
		return array(
			array('customer_skill_id, schedule_start, schedule_end, schedule_day, status', 'required'),
			array('customer_skill_id, schedule_start, schedule_end, schedule_day, status, is_deleted', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, customer_skill_id, schedule_start, schedule_end, schedule_day, status, is_deleted, date_created, date_updated', 'safe', 'on'=>'search'),
		);
	}
