...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
		<?php //echo $form->labelEx($model,'skill_child_disposition_id'); ?>
		<?php echo $form->hiddenField($model,'skill_child_disposition_id'); ?>
		<?php //echo $form->error($model,'skill_child_disposition_id'); ?>
	</div>

	<div class="form-group">
		<?php echo $form->labelEx($model,'skill_child_disposition_detail_name', array('class'=>'control-label col-sm-2')); ?>
		
		<div class="col-sm-10">
			<?php echo $form->textField($model,'skill_child_disposition_detail_name',array('size'=>60,'maxlength'=>150)); ?>
			<?php echo $form->error($model,'skill_child_disposition_detail_name'); ?>
		</div>
	</div>
