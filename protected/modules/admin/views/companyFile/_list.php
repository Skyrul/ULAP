...
<tr>
	...
	<td>
		<?php
			echo CHtml::link('<i class="fa fa-times"></i> Delete', array('delete', 'id'=>$data->id, 'companyId'=>$company_id), array('class'=>'btn btn-minier btn-danger', 'confirm'=>'Are you sure you want to delete this?'));
		?>
	</td>
