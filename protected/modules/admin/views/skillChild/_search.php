...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->label($model,'is_language'); ?>
		<?php echo $form->textField($model,'is_language'); ?>
	</div>
	...
	<div class="row">
		<?php echo $form->label($model,'is_reminder_call'); ?>
		<?php echo $form->textField($model,'is_reminder_call'); ?>
	</div>
