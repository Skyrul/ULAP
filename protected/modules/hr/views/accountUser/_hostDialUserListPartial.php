<tr>
	...
	<td>
		...
		<?php 
			if( Yii::app()->user->account->checkPermission('employees_hostdial_users_details_button','visible') )
			{
				if( Yii::app()->user->account->checkPermission('employees_hostdial_users_details_button','only_for_direct_reports', $data->id) )
				{
					echo CHtml::link('<i class="fa fa-search"></i> User Details',array('employeeDetails','id'=>$data->id),array('class'=>'btn btn-minier btn-info')); 
				}
			}
		?> 
