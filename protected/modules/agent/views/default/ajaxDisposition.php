<?php 
	...
	?>
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				<?php echo CHtml::dropDownList('Lead[office_phone_dispo_detail_id]', '', $dispositionDetailOptions, array('sub_dispo_is_required'=> $disposition->sub_dispo_is_required, 'phone_type'=>'office', 'field_type'=>'dispo_detail', 'prompt'=>'- Select -')); ?>
			</div>
		</div>
	<?php
	}
