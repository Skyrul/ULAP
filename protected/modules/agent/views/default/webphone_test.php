...
<?php	
	$cs->registerScript(uniqid(), "
        ...
        { 
			...
			// destnum = '814356503300';
			// destnum = '819093900003';
			// destnum = '818005158734';
			// destnum = '818603125090';
...
<?php	
//next lead and skip call button
$cs->registerScript(uniqid(), '
...
<?php	
//google map and calendar get direction
$cs->registerScript(uniqid(), '
...
<button type="button" class="btn btn-info btn-xs calendar-details-btn" style="position: absolute; top: 0px; left: 0px; width: 18px; border-radius: 0px 8px 8px 0px; margin-top: 70px; padding: 1px;">
	<i class="ace-icon fa fa-arrow-left bigger-110 icon-only"></i>
</button>

<button type="button" style="position: absolute; top: 0px; left: 0px; width: 18px; border-radius: 0px 8px 8px 0px; margin-top: 130px; padding: 1px; height:110px;/*! transform: rotate(90deg); */z-index: 9999;" class="btn btn-danger btn-xs end-call-btn disabled">
