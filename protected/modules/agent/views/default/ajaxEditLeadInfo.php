			...
			<div class="modal-header">
				...
				<h4 class="modal-title blue">
					<?php 
						...
						if( $fieldName == 'home_phone_number' && empty($model->home_phone_number) )
						{
							$modalTitle = '<i class="fa fa-plus"></i> Add Phone Number';
						}
						elseif( $fieldName == 'mobile_phone_number' && empty($model->mobile_phone_number) )
						{
							$modalTitle = '<i class="fa fa-plus"></i> Add Phone Number';
						}
						elseif( $fieldName == 'office_phone_number' && empty($model->office_phone_number) )
						{
							$modalTitle = '<i class="fa fa-plus"></i> Add Phone Number';
						}
						else
						{
							$modalTitle = '<i class="fa fa-pencil"></i>  Edit Lead Info';
						}
