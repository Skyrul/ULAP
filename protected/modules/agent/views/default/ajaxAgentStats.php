			...
			<div class="col-sm-11 col-sm-offset-1">
				<div class="pull-left">
					<?php 
						...
						{
							if( isset($accountUser) && $accountUser->getImage())
							{
				...
				<h3 class="pull-left" style="margin-left:30px;">
					<?php 
						if( isset($accountUser) )
						{
							echo $accountUser->getFullName(); 
						}
						else
						{
				...
				<?php if( $authAccount->getIsHostDialer() ): ?>
				
				<div class="pull-right" >
					<button class="btn btn-sm btn-yellow export-agent-call-log-btn"><i class="fa fa-file-excel-o"></i> Export to Excel</button>
				</div>
