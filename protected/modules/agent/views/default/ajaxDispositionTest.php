	...
	?>
		...
		<div class="form-group">
			...
			<div class="col-sm-7">
				...
				<?php 
					if( $dispositionDetailOptionsAttributes )
					{
						echo '<select id="Lead_office_phone_dispo_detail_id" phone_type="office", field_type="dispo_detail">';
						
							echo '<option value="" is_required="">- Select -</option>';
							
							foreach( $dispositionDetailOptionsAttributes as $dispositionDetailOptionsAttributesId => $dispositionDetailOptionsAttributesValue )
							{
								echo '<option value="'.$dispositionDetailOptionsAttributesId.'" is_required="'.$dispositionDetailOptionsAttributesValue["is_required"].'">'.$dispositionDetailOptionsAttributesValue["name"].'</options>';
							}
	...
	?>	
		<div class="form-group">
			<div class="col-sm-12">
				...
				<textarea placeholder="" style="width:100%; min-width:100%; resize: vertical;"><?php echo $agentNote; ?></textarea>
			</div>
		</div>
	<?php
	}
