<div class="row">
	<div class="col-sm-12">
		<div class="col-sm-6 widget-container">
			<div class="widget-box widget-color-blue2">
				<div class="widget-header">
					...
					<div class="widget-toolbar no-border lead-info-title-container">
				...
				<div class="widget-body">
					<div class="widget-main">
						...
						<div class="row-fluid">
							<div class="profile-user-info profile-user-info-striped lead-info-fields-container">
						...
						<div class="timeline-container" style="padding:0; margin:0;">
							<div class="timeline-item clearfix">
								<div class="widget-box transparent" style="margin-left:0;">
									<div class="widget-header widget-header-small">
										
										<span class="col-sm-4">
											<div style="line-height:35px; font-size:14px;"> Dialing as # <span class="dialingAs"></span></div>
										</span>
										
										<span class="col-sm-4">
											<div id="webphone-call-timer" style="text-align:center; line-height:35px; font-size:14px;">00:00:00</div>
										</span>
										
										<span class="col-sm-4 pull-right">
											<div id="webphone-events" class="text-right" style="line-height:35px; font-size:14px;"></div>
										</span>
									</div>
									...
									<div class="widget-body">
										<div class="widget-main">
											<div class="clearfix">
												<div class="col-sm-12 center dialer-function-btn-container">
						...
						<div class="row lead-info-phone-numbers-container">
		...
		<div class="col-sm-6 widget-container">
			<div class="widget-box widget-color-blue2 customer-info-fields-container">
				<div class="widget-header">
						<h4 class="widget-title lighter smaller">
			...
			<div class="row">
				<div class="col-sm-12 widget-container">				
					<div class="widget-box widget-color-blue2 lead-history-container">
						<div class="widget-header">
							<h4 class="widget-title lighter smaller">
								LEAD HISTORY
							</h4>
