...
$cs->registerScriptFile($baseUrl.'/js/agent/dialer.js',  CClientScript::POS_END);

$cs->registerScriptFile($baseUrl.'/js/agent/appointments.js',  CClientScript::POS_END);

$cs->registerScriptFile($baseUrl.'/js/agent/lead_search.js',  CClientScript::POS_END);

$cs->registerScriptFile($baseUrl.'/js/agent/map_directions.js',  CClientScript::POS_END);

$cs->registerScriptFile($baseUrl.'/js/agent/dial_pad.js',  CClientScript::POS_END);
...
$cs->registerScript(uniqid(), '
	...
	{
		if( $(".end-call-btn").hasClass("disabled") && $("#leadPhoneNumbers").find("tr td select.dispo-select:enabled").val() )
		{
