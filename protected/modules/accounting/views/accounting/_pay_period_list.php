...
<tr class="<?php echo $trClass; ?>">
	...
	<td><?php echo $data->account->getFullName(); ?></td>
	...
	<td>
		<?php if( Yii::app()->user->account->checkPermission('accounting_exception_punches_edit_button','visible') ){ ?>
		...
		<?php if( $data->status != 1 && Yii::app()->user->account->checkPermission('accounting_exception_punches_action_button','visible') ): ?>
