									...
									<td>
										<?php 
											$homePhoneHtmlOptions = array(
												'class' => !empty($leadCallHistory) && $leadCallHistory->lead_phone_number == $lead->home_phone_number ? 'grey' : 'green dial-phonenumber-btn',
												'phone_type'=>'home',
												'lead_id' => $lead->id,
												'list_id' => $list->id,
									...
									<td>
										<?php 
											$mobilePhoneHtmlOptions = array(
												'class' => !empty($leadCallHistory) && $leadCallHistory->lead_phone_number == $lead->mobile_phone_number ? 'grey' : 'green dial-phonenumber-btn',
												'phone_type'=>'mobile',
												'lead_id' => $lead->id,
												'list_id' => $list->id,
												'customer_id' => $customer->id,
									...
									<td>
										<?php 
											$officePhoneHtmlOptions = array(
												'class' => !empty($leadCallHistory) && $leadCallHistory->lead_phone_number == $lead->office_phone_number ? 'grey' : 'green dial-phonenumber-btn',
												'phone_type'=>'office',
												'lead_id' => $lead->id,
												'list_id' => $list->id,
												'customer_id' => $customer->id,
