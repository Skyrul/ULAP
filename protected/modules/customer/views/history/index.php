...
<div class="page-header">
	<h1>
		...
		<?php if( !in_array(Yii::app()->user->account->account_type_id, array(Account::TYPE_PORTAL, Account::TYPE_CUSTOMER, Account::TYPE_CUSTOMER_OFFICE_STAFF, Account::TYPE_AGENT, Account::TYPE_COMPANY)) && Yii::app()->user->account->checkPermission('customer_history_show_audit_records_button','visible') ){ ?>
		<label>
			<small>
...
<?php if( Yii::app()->user->account->checkPermission('customer_history_add_record','visible') ){ ?>
