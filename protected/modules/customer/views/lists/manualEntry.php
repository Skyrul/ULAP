...
<div class="page-header">
	<h1>
		Manual Entry
		<button class="btn btn-sm btn-primary btn-add-tbl-rows"><i class="fa fa-plus"></i> Add Rows</button>
	</h1>
</div>
...
<div class="row form-actions center">
	<button class="btn btn-sm btn-primary btn-form-submit">Submit <i class="fa fa-arrow-right"></i></button>
</div>
