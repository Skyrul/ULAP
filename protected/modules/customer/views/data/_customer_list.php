...
<tr>
	...
	<td class="center">
		...
		<?php 
			...
			{
				$dashboarUrl = $data->company->is_host_dialer == 1 ? '/hostDial/insight/index' : '/customer/insight/index';
				
				echo CHtml::link('<i class="fa fa-user"></i> Account Details',array($dashboarUrl,'customer_id'=> $data->id ),array('class'=>'btn btn-minier btn-info')); 
			}
		?>
