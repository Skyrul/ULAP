		...
		<div class="col-md-7">
			...
			<?php 
				...
				?>
					...
					<?php if( Yii::app()->user->account->checkPermission('customer_company_dropdown','visible') ): ?>
					
					<div class="profile-user-info profile-user-info-striped">
						<div class="profile-info-row">
							<div class="profile-info-name "><?php echo $form->labelEx($model,'company_id'); ?></div>
							<div class="profile-info-value">
								<?php echo $form->dropDownList($model,'company_id',Company::listCompanies(),array('empty'=>'-Select Company-', 'disabled' => Yii::app()->user->account->checkPermission('customer_company_dropdown','edit') )); ?>
					...
					<div class="profile-user-info profile-user-info-striped">
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<?php echo $form->textField($model,'account_number',array('disabled'=>true)); ?>
					...
					<div class="profile-user-info profile-user-info-striped">
						<div class="profile-info-row">
							<div class="profile-info-name "><?php echo $form->labelEx($model,'middlename'); ?></div>
							<div class="profile-info-value">
								<?php echo $form->textField($model,'middlename',array('maxlength'=>120, 'disabled'=>$inputDisabled)); ?>
					...
					<div class="profile-user-info profile-user-info-striped">
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<?php echo $form->textField($model,'name_alias',array('maxlength'=>120, 'disabled'=>$inputDisabled)); ?>
					...
					<div class="profile-user-info profile-user-info-striped">
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<?php echo $form->textField($model,'fax',array('maxlength'=>60, 'class'=>'input-mask-phone', 'disabled'=>$inputDisabled)); ?>
					...
					<div class="profile-user-info profile-user-info-striped">
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<?php echo $form->textField($model,'mobile',array('maxlength'=>60, 'class'=>'input-mask-phone', 'disabled'=>$inputDisabled)); ?>
				...
				?>
					...
					<div class="profile-user-info profile-user-info-striped">
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<?php echo $form->textField($model,'address1',array('maxlength'=>250, 'disabled'=>$inputDisabled)); ?>
					...
					<div class="profile-user-info profile-user-info-striped">
						<div class="profile-info-row">
							...
							<div class="profile-info-value">
								<?php echo $form->textField($model,'address2',array('maxlength'=>250, 'disabled'=>$inputDisabled)); ?>
