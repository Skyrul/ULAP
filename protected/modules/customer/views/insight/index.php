<?php 
	...
	$cs->registerCss(uniqid(), '
		...
		.popup-close-btn{ position:absolute; font-size:32px !important; top:5px; right:15px; }
	');
...
<!-- Company Popup Modal -->
<?php
	if( isset($_GET['popup']) && $customer->company->popup_show == 1 && $customerPopupLoginCount <= $customer->company->popup_logins && !empty($customer->company->popup_html_content) )
	{			
		echo '
			<div class="modal fade" id="companyPopupModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
			  <div class="modal-dialog modal-lg" role="document" style="width:50%;">
				<div class="modal-content">
				  <div class="modal-body" style="padding:20px;position:relative;">
					...
					'.$customer->company->popup_html_content.'
				  </div>
				</div>
			  </div>
			</div>';
