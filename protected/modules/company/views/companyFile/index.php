...
<div class="row">
	<div class="col-sm-12">
		<form action="<?php echo $this->createUrl('upload', array('company_id'=>$company->id)); ?>" id="dropzone" class="dropzone" method="post" enctype="multipart/form-data">
			<div class="fallback">
	...
	<div class="col-sm-12">
		<?php 
			$this->widget('zii.widgets.CListView', array(
				...
				'viewData' => array('company_id'=>$company->id),
				'itemView'=>'_list',
