...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 16, 2015 at 07:18 AM
...
INSERT INTO `ud_company` (`id`, `company_name`, `status`, `is_deleted`, `date_created`, `date_updated`) VALUES
(1, 'EngageX', 1, 0, '2015-07-01 00:00:00', '2015-07-16 00:00:00'),
(2, 'Zeniark', 1, 0, '2015-07-16 00:00:00', '2015-07-16 00:00:00');
...
INSERT INTO `ud_customer` (`id`, `firstname`, `middlename`, `lastname`, `gender`, `phone`, `fax`, `mobile`, `email_address`, `address1`, `address2`, `city`, `state`, `zip`, `status`, `is_deleted`, `date_created`, `date_updated`) VALUES
(1, 'Mark', 'Cunanan', 'Juan', 'm', 'none', 'none', '09356902869', 'markjuan169@gmail.com', '841 Friendship Hi Way', '', 'Angeles City', NULL, '2009', 1, 0, '2015-07-16 00:00:00', '2015-07-16 00:00:00');

-- --------------------------------------------------------

--
-- Table structure for table `ud_customer_company`
--

CREATE TABLE IF NOT EXISTS `ud_customer_company` (
  `id` int(11) NOT NULL,
...
ALTER TABLE `ud_customer`
  ADD PRIMARY KEY (`id`), ADD KEY `email_address` (`email_address`), ADD KEY `state` (`state`);

--
-- Indexes for table `ud_customer_company`
--
ALTER TABLE `ud_customer_company`
  ADD PRIMARY KEY (`id`), ADD KEY `customer_company` (`customer_id`,`company_id`), ADD KEY `customer_id` (`customer_id`), ADD KEY `company_id` (`company_id`);
...
--
-- AUTO_INCREMENT for table `ud_customer_company`
--
ALTER TABLE `ud_customer_company`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
-- Constraints for table `ud_customer_company`
--
ALTER TABLE `ud_customer_company`
ADD CONSTRAINT `ud_customer_company_ibfk_1` FOREIGN KEY (`company_id`) REFERENCES `ud_company` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `ud_customer_company_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `ud_customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
