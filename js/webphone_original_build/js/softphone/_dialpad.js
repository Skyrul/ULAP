...
function DeleteContact(ctid, popupafterclose)
{
    ...
    var template = '' +
'<div id="dp_delete_contact_popup" data-role="popup" class="ui-content messagePopup" data-overlay-theme="a" data-theme="a" style="max-width:' + popupWidth + 'px;">' +
...
'</div>';
    ...
    j$('#btn_adialog_ok').on('click', function ()
    {
        ...
        common.SaveContactsFile(function (issaved) { common.PutToDebugLog(4, 'EVENT, _dialpad: DeleteContact SaveContactsFile: ' + issaved.toString()); });

        PopulateListRecents();
    });
    } catch(err) { common.PutToDebugLogException(2, "_dialpad: DeleteContact", err); }
}
*/
