...
var settOrderWebphone = 'serveraddress_user,sipusername,password,submenu_sipsettings,submenu_media,submenu_calldivert,submenu_general,theme,language,accounts,email,incomingcallpopup,sendchatonenter,keeprecfiles,proxyaddress,realm,username,displayname,hidemyidentity,usetunneling,transport,use_fast_ice,use_stun,use_rport,register,registerinterval,keepaliveival,keepalive,natopenpackets,ringtimeout,calltimeout,dtmfmode,chatsms,prack,earlymedia,sendrtponmuted,defmute,changesptoring,localip,signalingport,rtpport,capabilityrequest,customsipheader,normalizenumber,techprefix,filters,callforwardonbusy,callforwardonnoanswer,callforwardalways,calltransferalways,transfwithreplace,autoignore,autoaccept,voicemailnum,callbacknumber,blacklist,transfertype,automute,autohold,dialerintegration,integrateifwifionly,nativefilterallow,nativefilterblock,audiodevices,displayvolumecontrols,displayaudiodevice,savetocontacts,telsearchkey,extraoption,reset_settings,loglevel,loglevel_dbg,playring,codec,alwaysallowlowcodec,'+
...
var settOrderWebphoneWebRTCFlash = 'serveraddress_user,sipusername,password,submenu_sipsettings,submenu_media,submenu_calldivert,submenu_general,theme,language,accounts,email,incomingcallpopup,sendchatonenter,keeprecfiles,proxyaddress,realm,username,displayname,hidemyidentity,usetunneling,ringtimeout,calltimeout,dtmfmode,chatsms,earlymedia,defmute,customsipheader,normalizenumber,techprefix,filters,voicemailnum,callbacknumber,callforwardonbusy,callforwardonnoanswer,callforwardalways,calltransferalways,transfwithreplace,autoignore,autoaccept,blacklist,dialerintegration,integrateifwifionly,nativefilterallow,nativefilterblock,audiodevices,displayvolumecontrols,displayaudiodevice,savetocontacts,telsearchkey,extraoption,reset_settings,loglevel,loglevel_dbg,codec,alwaysallowlowcodec,'+
        'audio_bandwidth,video,video_bandwidth,video_width,video_height,'+
        'cfgvideo,video_profile,videocodec,'+ aspeak +
//        'submenu_screenshare,sscontrol,ssscroll,sstop,ssquality,'+
...
var settOrderWin = 'serveraddress_user,sipusername,password,submenu_sipsettings,submenu_media,submenu_calldivert,submenu_general,theme,language,accounts,email,sendchatonenter,keeprecfiles,proxyaddress,realm,username,displayname,flash,beeponincoming,importonlywithnum,hidemyidentity,usetunneling,transport,use_fast_ice,use_stun,use_rport,register,registerinterval,keepaliveival,keepalive,natopenpackets,ringtimeout,calltimeout,dtmfmode,chatsms,prack,earlymedia,sendrtponmuted,defmute,changesptoring,localip,signalingport,rtpport,capabilityrequest,customsipheader,normalizenumber,techprefix,filters,callforwardonbusy,callforwardonnoanswer,callforwardalways,calltransferalways,transfwithreplace,autoignore,autoaccept,rejectonvoipbusy,voicemailnum,callbacknumber,blacklist,transfertype,automute,autohold,startwithos,dialerintegration,integrateifwifionly,nativefilterallow,nativefilterblock,audiodevices,displayvolumecontrols,displayaudiodevice,savetocontacts,telsearchkey,extraoption,reset_settings,loglevel,loglevel_dbg,playring,'
...
var basicSettings = 'settobasefunctionality,theme,username,displayname,usetunneling,transport,proxyaddress,register,ringtone,audiodevices,startonboot,dialerintegration,integrateifwifionly,nativefilterallow,nativefilterblock,cpualwayspartiallock,forcewifi,accounts,email,loglevel,startwithos';
var basicSettingsCustomized = 'settobasefunctionality,theme,displayname,ringtone,audiodevices,startonboot,dialerintegration,integrateifwifionly,nativefilterallow,nativefilterblock,cpualwayspartiallock,forcewifi,accounts,email,loglevel,startwithos';
...
//            });
            ...
            if (common.GetParameter('serverinputisupperserver') === 'true')
            {
                ...
                if (common.RandomInt(0, 100) < 50) { srv = global.autoprovsrv_1; } else { srv = global.autoprovsrv_2; }
...
function onDestroy (event)
{
    ...
    printdevice = false;
    /*
    j$('#settings_list').off('click', 'li');
    j$('#settings_menu_ul').off('click', 'li');*/
