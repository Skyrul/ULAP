	...
	$(document).ready( function(){ 
		...
		var calendar = $('#calendar').fullCalendar({
			...
			events: function(start, end, timezone, callback) {
				...
				$.ajax({
					url: yii.urls.absoluteUrl + '/calendarTest/index',
					type: 'post',
					dataType: 'json',
					data: {
						"loadEvents": 1,
			...
			select: function(start, end, jsEvent, view) {	
				...
				{			
					...
					$.ajax({
						url: yii.urls.absoluteUrl + '/calendarTest/create',
						type: 'post',
						dataType: 'json',
						...
						success: function(response) {
							...
							modal.on("click", ".start-time-option", function(){
								...
								if( start_date_time != "" )
								{
									...
									$.ajax({
										url: yii.urls.absoluteUrl + '/calendarTest/autoFillEndDate',
										type: 'post',
										dataType: 'json',
			...
			eventResize: function(calEvent, delta, revertFunc) {
				...
				if( !blackOutFormOngoing )
				{
					...
					$.ajax({
						url: yii.urls.absoluteUrl + '/calendarTest/update',
						type: 'post',
						dataType: 'json',
						data: { 
						...
						success: function(response) {
							...
							if(response.html != "")
							{
								...
								modal.find('button[data-action=save]').on('click', function() {
									...
									$.ajax({
										url: yii.urls.absoluteUrl + '/calendarTest/' + action,
										type: 'post',
										dataType: 'json',
										data: data,
										success: function(response) {
			...
			drop: function(date, allDay, resource, event) { 
				...
				if( !blackOutFormOngoing )
				{
					...
					$.ajax({
						url: yii.urls.absoluteUrl + '/calendarTest/blackoutDays',
						type: 'post',
						dataType: 'json',
						data: { 
							"calendar_id": current_calendar_id,
			...
			eventRender: function (event, element, icon) {
				...
				if( event.title != 'BLACKOUT DAYS' && event.custom != 3 && viewer == 'customer' )
				{
					...
					element.find(".delete-slot").click(function() {
						...
						{
							$.ajax({
								url: yii.urls.absoluteUrl + '/calendarTest/deleteSlot',
								type: 'post',
								dataType: 'json',
						...
						success: function(response) {
							...
							modal.find('button[data-action=suggest]').on('click', function() {
								...
								if( suggest_clicked == 2)
								{
									...
									$.ajax({
										url: yii.urls.absoluteUrl + '/calendarTest/actionForm',
										type: 'post',
										dataType: 'json',
										data: data,
										success: function(response) {
		...
		$(document).on("click", ".calendar-settings", function(){
			...
			$.ajax({
				url: yii.urls.absoluteUrl + '/calendarTest/settings',
				type: 'post',
				dataType: 'json',
				data: {
						"ajax":1, 'id':id
		...
		$(document).on("click", ".manage-schedule", function(){
			...
			$.ajax({
				url: yii.urls.absoluteUrl + '/calendarTest/manageSchedule',
				type: 'post',
				dataType: 'json',
				data: { "ajax":1, 'id':id },
				success: function(response) {
					...
					modal.find('button[data-action=applyHolidays]').on('click', function() {
						...
						$.ajax({
							url: yii.urls.absoluteUrl + '/calendarTest/applyHolidays',
							type: 'post',
							dataType: 'json',
							data: data,
							beforeSend: function(){
