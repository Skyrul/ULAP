...
var parameters = {
    /*
                                                ...
                                                webrtcserveraddress: 'wss://rtc.mizu-voip.com/mfstwebsock',
                                                serveraddress: 'jcdecauxnorthamerica.onsip.com',
                                                proxyaddress: 'sip.onsip.com',
                                                username: 'hou_vd',
                                                sipusername: 'jcdecauxnorthamerica_hou_vd',
                                                password: 'ono9YzbvjdNRefvj', 
                                                enginepriority_webrtc: 4,
                                                displayname: 'Akoska',
*/
    
    
    
//        serveraddress: '10.92.69.114 ',
//        webrtcserveraddress: 'ws://10.92.69.114/mfstwebsock',
//        wsuser: 'http://10.92.69.114/mvapireq/?apientry=wsuser&authkey=589805118&authid=USERNAME&authpwd=PASSWORD&brandname=BMWebPhone&companyname=BlueMosaic&upperserver=10.92.68.101&upperserverdomain=uccucm.cx.ciscolabs.com',
//       stunserveraddress: '10.92.69.114:8090',
//        turnserveraddress: '10.92.69.114:80',
//        turnparameters: 'transport=tcp',
//        turnusername: 'mzturnusr',
//        turnpassword: 'rnd87719318572',
//        username: '1001011',
//        password: 'webrtc1',
/*
            enablepresence: 0,
            enablepres_httpapi: 1,
            enablepres_javaapi: 1,
            enablepres_webrtc: 0,
...
/*
            serveraddress: '119.81.157.182', // your VoIP server IP address, domain name or SRV DNS record (also set the :port if that is not the default 5060)
            ...
            enginepriority_webrtc: 4,
            password: 'nopassword',
            enginepriority_app: 2,
            enablepresence: 0,
            hidesettings: 'disablecontactmenu, page_contacts',
            disableoptions: 'disablecontactmenu, page_contacts',
            savetocontacts: 0,
            //webrtcserveraddress: 'www://demo.iedacademy.com:1062',
            webrtcserveraddress: '',
            dtmfmode: 2,
*/
            
            // webrtcserveraddress: 'wss://sip1.engagex.com:8089/ws'
            webrtcserveraddress:'wss://rtc.mizu-voip.com:2443/mfstwebsock',
//            webrtcserveraddress:'wss://usrtcx.webvoipphone.com/mfstwebsock',
//            webrtcserveraddress:'ws://rtc.mizu-voip.com/mfstwebsock',
            serveraddress: 'rtc.mizu-voip.com:6060',
            username: '1000',
            password: 'aaaa',

//                serveraddress: 'voip.mizu-voip.com',
//                username: '8888',
//                password: '8888xxx',
...
//              enginepriority_java: 5,
//              enginepriority_flash: 0,
                

//                    webcontact_url: 'https://tel.search.ch/api/?was=CALLEDNUMBER&key=3606e399f2ec49f31831949efba6daf1',
                    //password: 'encrypted__3__UQoAUBwaHg==',
                    /*conferencerooms: 1,*/

                    /*scurl_onload: '',
//                  scurl_setparameters: 'http://127.0.0.1:8080',
//                  scurl_setparameters: 'http://httpbin.org/ip',
                    scurl_onstart: '',
                    scurl_setparameters: '',
                    scurl_onoutcallsetup: '',
                    scurl_onoutcallringing: '',
                    scurl_onoutcallconnected: '',
                    scurl_onoutcalldisconnected: '',
                    scurl_onincallsetup: '',
                    scurl_onincallringing: '',
                    scurl_onincallconnected: '',
                    scurl_onincalldisconnected: '',
                    scurl_oninchat: '',
                    scurl_onoutchat: '',*/
