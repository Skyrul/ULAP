...
var settOrderWebphoneWebRTCFlash = 'serveraddress_user,sipusername,password,submenu_sipsettings,submenu_media,submenu_calldivert,submenu_general,theme,language,'+ exregacc +'email,incomingcallpopup,sendchatonenter,keeprecfiles,proxyaddress,realm,username,displayname,hidemyidentity,usetunneling,ringtimeout,calltimeout,enableblf,dtmfmode,chatsms,earlymedia,defmute,customsipheader,normalizenumber,techprefix,filters,voicemailnum,callbacknumber,callforwardonbusy,callforwardonnoanswer,callforwardalways,calltransferalways,transfwithreplace,autoignore,autoaccept,blacklist,dialerintegration,integrateifwifionly,nativefilterallow,nativefilterblock,audiodevices,displayvolumecontrols,displayaudiodevice,savetocontacts,telsearchkey,extraoption,pushnotifications,reset_settings,loglevel,loglevel_dbg,codec,alwaysallowlowcodec,'+
        'audio_bandwidth,video,video_bandwidth,video_width,video_height,'+
        'cfgvideo,video_profile,videocodec,'+ aspeak +
//--        'submenu_screenshare,sscontrol,ssscroll,sstop,ssquality,'+
