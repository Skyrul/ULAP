$( function(){
	...
	$(document).ready( function(){
		...
		$(document).on("click", "#appointmentsTab", function(){
			
			var tab_content_div = $("#appointments");
			
			if( tab_content_div.html() == "" )
			{
				$.ajax({
					url: yii.urls.absoluteUrl + "/agent/default/loadAppointmentsTab",
					type: "post",
					dataType: "json",
					data: { "ajax":1, "lead_id":current_lead_id },
					beforeSend: function(){ 
						$("#appointments").html("<h1 class=\"blue center lighter\">Loading calendar please wait...</h1>");
					},
					error: function(){
						$("#appointments").html("<h1 class=\"red center lighter\">Error on loading calendar</h1>");
					},
					success: function(response) { 
						...
						{
							tab_content_div.html("<h1 class=\"red center lighter\">Error on loading calendar</h1>");
						}
					}
				});
			}
		...
		$(document).on("click", "#emailSettingTab", function(){

			var tab_content_div = $("#emailSetting");
		
			if( tab_content_div.html() == "" )
			{
				$.ajax({
					url: yii.urls.absoluteUrl + "/agent/emailer/loadTab",
					type: "post",
					dataType: "json",
					data: { "ajax":1, 
					...
					beforeSend: function(){ 
						tab_content_div.html("<h1 class=\"blue center lighter\">Loading email templates please wait...</h1>");
					},
					error: function(){
						tab_content_div.html("<h1 class=\"red center lighter\">Error on loading email setting</h1>");
					},
					success: function(response) {
		...
		$(document).on("click", "#mapTab", function(){
			...
			var tab_content_div = $("#googlemap");
			
			// if( tab_content_div.html() == "" )
			// {
				$.ajax({
					url: yii.urls.absoluteUrl + "/agent/default/loadMapTab",
					type: "post",
					dataType: "json",
					data: { "ajax":1, "lead_id":current_lead_id },
					beforeSend: function(){ 
						tab_content_div.html("<h1 class=\"blue center lighter\">Loading map please wait...</h1>");
					},
					error: function(){
						tab_content_div.html("<h1 class=\"red center lighter\">Error on loading map</h1>");
					},
					success: function(response) { 
